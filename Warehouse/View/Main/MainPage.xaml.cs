...
namespace Warehouse.View.Main
{
    public partial class MainPage : Window
    {
        ...
        private void EditProduct_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (selectedRow != null)
            {
                string message = "ProductEdit productEdit = new ProductEdit(" +
    $"Convert.ToInt32(selectedRow.Row.ItemArray[0]) 0: {selectedRow.Row.ItemArray[0]},\n" +
    $"Convert.ToString(selectedRow.Row.ItemArray[1]) 1: {selectedRow.Row.ItemArray[1]},\n" +
    $"Convert.ToString(selectedRow.Row.ItemArray[2]) 2: {selectedRow.Row.ItemArray[2]},\n" +
    $"Convert.ToString(selectedRow.Row.ItemArray[3]) 3: {selectedRow.Row.ItemArray[3]},\n" +
    $"Convert.ToString(selectedRow.Row.ItemArray[4]) 4: {selectedRow.Row.ItemArray[4]},\n" +
    $"Convert.ToString(selectedRow.Row.ItemArray[5]) 5: {selectedRow.Row.ItemArray[5]},\n" +
    "ProductGrid);";
        ...
        private void Car_PreviewMouseLeftButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            SupplierGrid.Visibility = Visibility.Collapsed;
            ProductGrid.Visibility = Visibility.Collapsed;
            OrderGrid.Visibility = Visibility.Collapsed;
            ...
            database.ReadCar(CarGrid);
        }

        private void VetDataGrid_PreviewMouseLeftButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
